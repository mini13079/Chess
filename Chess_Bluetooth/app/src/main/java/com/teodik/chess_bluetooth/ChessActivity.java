...
public class ChessActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int origin;
    private int rook_location;
    private int destination;
    private boolean w_king_move;
    private boolean b_king_move;
    private boolean l_b_rook;
    private boolean r_b_rook;
    private boolean r_w_rook;
    private boolean l_w_rook;
    ...
    private boolean kingcheck(){
        ...
        if(turn) {
            ...
            if ((destination - 8) % 8 == destination % 8 && destination - 8  >= 0 && destination - 8 < 64) {

                Log.e("piece", buttons[destination - 8].getTag().toString());
                if (buttons[destination - 8].getTag().toString().equals(character))
                    verify = false;

            }
            if (((destination - 9) % 8) + 1 == destination % 8 && destination - 9 >= 0 && destination - 9< 64) {
                Log.e("piece", buttons[destination - 9].getTag().toString());
                if (buttons[destination - 9].getTag().toString().equals(character))
                    verify = false;

            }
            if (((destination - 7) % 8) - 1 == destination % 8 && destination - 7 >= 0 && destination - 7 < 64) {
                Log.e("piece", buttons[destination - 7].getTag().toString());
                if (buttons[destination - 7].getTag().toString().equals(character))
                    verify = false;
            }
            if (((destination - 1) % 8) + 1 == destination % 8 && destination - 1 >= 0 && destination - 1 < 64) {
                Log.e("piece", buttons[destination - 1].getTag().toString());
                if (buttons[destination - 1].getTag().toString().equals(character))
                    verify = false;
            }
            if (((destination + 1) % 8) - 1 == destination % 8 && destination + 1>= 0 && destination + 1 < 64) {
                Log.e("piece", buttons[destination + 1].getTag().toString());
    ...
    private Runnable king = new Runnable() {
        ...
        public void run() {
            ...
            if(((destination%8 ==origin%8 + 1)||(destination%8 ==origin%8 - 1) || (destination%8 ==origin%8))
                    &&((destination/8==origin/8)||(destination/8==origin/8 - 1)||(destination/8==origin/8 + 1))){
                if(kingcheck())
                    validate=true;
                else
                    validate=false;
            ...
            Log.e("status",Boolean.toString(l_w_rook)+Boolean.toString(r_w_rook)+w_king_move+turn+destination);

            if (turn && !r_w_rook && !w_king_move && destination == 62 ){
               if(buttons[61].getTag().toString().equals("") && buttons[62].getTag().toString().equals("")){
                   rook_location=63;
                   savedTag=buttons[63].getTag().toString();
                   buttons[destination].setTag("WK");
                   Log.e("destination","0");
                   buttons[origin].setTag("");
                   buttons[destination - 1].setTag("WR");
                   buttons[rook_location].setTag("");
                   handler.post(new castle(destination,destination -1));
                   validate=true;

               }

            }
             if (turn && !l_w_rook && !w_king_move && destination == 58 ){
                 Log.e("reach","im here");

                 if(buttons[57].getTag().toString().equals("") && buttons[58].getTag().toString().equals("")&&buttons[59].getTag().toString().equals("") ){
                     Log.e("reach","im there");
                    rook_location=56;
                    savedTag=buttons[56].getTag().toString();
                    Log.e("destination","1");
                    buttons[destination].setTag("WK");
                    buttons[origin].setTag("");
                    buttons[destination + 1].setTag("WR");
             ...
             if (!turn && !r_b_rook && !b_king_move && destination == 6 ){
                if(buttons[5].getTag().toString().equals("") && buttons[6].getTag().toString().equals("")){
                    rook_location=7;
                    savedTag=buttons[7].getTag().toString();
                    Log.e("destination","2");
                    buttons[destination].setTag("BK");
                    buttons[origin].setTag("");
                    buttons[destination - 1].setTag("BR");
                    buttons[rook_location].setTag("");
                    handler.post(new castle(destination,destination -1));
                    validate=true;
                }
            ...
            if (!turn && !l_b_rook && !b_king_move && destination == 2 ){
                if(buttons[1].getTag().toString().equals("") && buttons[2].getTag().toString().equals("")&&buttons[3].getTag().toString().equals("") ){
                    rook_location=0;
                    Log.e("destination","3");
                    savedTag=buttons[0].getTag().toString();
                    buttons[destination].setTag("BK");
                    buttons[origin].setTag("");
                    buttons[destination + 1].setTag("BR");
                    buttons[rook_location].setTag("");
    ...
    private class castle implements Runnable{
        ...
        public void run() {
            ...
            if(turn){
                ...
                if (!check){
                    if((king + 6) < 64 && ((king + 6) % 8 == (king % 8 - 2))){
                        if(buttons[king + 6].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king - 10) > 0 && ((king - 10) % 8 == (king % 8 - 2))){
                        if(buttons[king - 10].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king - 17) > 0 && ((king - 17) % 8 == (king % 8 - 1))){
                        if(buttons[king - 17].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king + 15) < 64 && ((king + 15) % 8 == (king % 8 - 1))){
                        if(buttons[king + 15].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king - 15) > 0 && ((king - 15) % 8 == (king % 8 + 1))){
                        if(buttons[king - 15].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king + 17) < 64 && ((king + 17) % 8 == (king % 8 + 1))){
                        if(buttons[king + 17].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king - 6) > 0 && ((king - 6) % 8 == (king % 8 + 2))){
                        if(buttons[king - 6].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((king + 10) < 64 && ((king + 10) % 8 == (king % 8 + 2))){
                        if(buttons[king + 10].getTag().toString().equals("BN"))
                            check = true;
                    }
                }
                if(!check && king > 15){
                    if(king % 8 == (king - 7) % 8 - 1 && (buttons[king - 7].getTag().toString().equals("BP")))
                        check = true;
                    else if(king % 8 == (king - 9) % 8 + 1 && (buttons[king - 9].getTag().toString().equals("BP")))
                        check = true;
                }
            }
            else{
                ...
                if(!check){
                    if((king + 6) < 64 && ((king + 6) % 8 == (king % 8 - 2))){
                        if(buttons[king + 6].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((king - 10) > 0 && ((king - 10) % 8 == (king % 8 - 2))){
                        if(buttons[king - 10].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((king - 17) > 0 && ((king - 17) % 8 == (king % 8 - 1))){
                        if(buttons[king - 17].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((king + 15) < 64 && ((king + 15) % 8 == (king % 8 - 1))){
                        if(buttons[king + 15].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((king - 15) > 0 && ((king - 15) % 8 == (king % 8 + 1))){
                        if(buttons[king - 15].getTag().toString().equals("WN"))
                ...
                if(!check && king < 48){
                    if(king % 8 == (king + 7) % 8 + 1 && (buttons[king + 7].getTag().toString().equals("WP")))
                        check = true;
                    else if (king % 8 == (king + 9) % 8 - 1 && (buttons[king + 9].getTag().toString().equals("WP")))
                        check = true;
                }
            }
            ...
            if(turn && !check){
                ...
                if (!check){
                    if((rook + 6) < 64 && ((rook + 6) % 8 == (rook % 8 - 2))){
                        if(buttons[rook + 6].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook - 10) > 0 && ((rook - 10) % 8 == (rook % 8 - 2))){
                        if(buttons[rook - 10].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook - 17) > 0 && ((rook - 17) % 8 == (rook % 8 - 1))){
                        if(buttons[rook - 17].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook + 15) < 64 && ((rook + 15) % 8 == (rook % 8 - 1))){
                        if(buttons[rook + 15].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook - 15) > 0 && ((rook - 15) % 8 == (rook % 8 + 1))){
                        if(buttons[rook - 15].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook + 17) < 64 && ((rook + 17) % 8 == (rook % 8 + 1))){
                        if(buttons[rook + 17].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook - 6) > 0 && ((rook - 6) % 8 == (rook % 8 + 2))){
                        if(buttons[rook - 6].getTag().toString().equals("BN"))
                            check = true;
                    }
                    if((rook + 10) < 64 && ((rook + 10) % 8 == (rook % 8 + 2))){
                        if(buttons[rook + 10].getTag().toString().equals("BN"))
                            check = true;
                    }
                }
                if(!check && rook > 15){
                    if(rook % 8 == (rook - 7) % 8 - 1 && (buttons[rook - 7].getTag().toString().equals("BP")))
                        check = true;
                    else if(rook % 8 == (rook - 9) % 8 + 1 && (buttons[rook - 9].getTag().toString().equals("BP")))
                        check = true;
                }
            }
            else if(!turn && !check){
                ...
                if(!check){
                    if((rook + 6) < 64 && ((rook + 6) % 8 == (rook % 8 - 2))){
                        if(buttons[rook + 6].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((rook - 10) > 0 && ((rook - 10) % 8 == (rook % 8 - 2))){
                        if(buttons[rook - 10].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((rook - 17) > 0 && ((rook - 17) % 8 == (rook % 8 - 1))){
                        if(buttons[rook - 17].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((rook + 15) < 64 && ((rook + 15) % 8 == (rook % 8 - 1))){
                        if(buttons[rook + 15].getTag().toString().equals("WN"))
                            check = true;
                    }
                    if((rook - 15) > 0 && ((rook - 15) % 8 == (rook % 8 + 1))){
                        if(buttons[rook - 15].getTag().toString().equals("WN"))
                ...
                if(!check && rook < 48){
                    if(rook % 8 == (rook + 7) % 8 + 1 && (buttons[rook + 7].getTag().toString().equals("WP")))
                        check = true;
                    else if (rook % 8 == (rook + 9) % 8 - 1 && (buttons[rook + 9].getTag().toString().equals("WP")))
                        check = true;
                }
            }

            if(check){
                buttons[rook_location].setTag(savedTag);
                buttons[origin].setTag(piece);
                buttons[king].setTag("");
                buttons[rook].setTag("");
                Toast.makeText(ChessActivity.this, "pieces under check!", Toast.LENGTH_LONG).show();
                ...
                buttons[king].setImageResource(getImage());
                piece=savedTag;
                buttons[rook].setImageResource(getImage());
                buttons[rook_location].setImageResource(0);
                ...
                else if(rook_location==7){
                    r_b_rook=true;

                }
                else if(rook_location==56){
                    l_w_rook=true;

                }
                else if(rook_location==63){
                    r_w_rook=true;
